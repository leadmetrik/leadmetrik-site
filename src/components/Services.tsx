...
const packages = [
  {
    ...
    tagline: 'Get Found',
    price: '500',
    description: 'Build your SEO foundation and start ranking locally',
    features: [
      'Complete SEO audit & analysis',
      'Local citation building (50+ directories)',
      'Google Business Profile optimization',
      'Foundation backlink building',
  ...
  },
  {
    ...
    tagline: 'Get Leads',
    price: '1,200',
    description: 'Aggressive link building and ongoing optimization',
    features: [
      'Everything in Starter',
      'Guest posting & niche edits',
      'Google News link building',
      'Community & local news posts',
  ...
  },
  {
    ...
    price: '2,500',
    description: 'Premium link building for maximum market domination',
    features: [
      'Everything in Growth',
      'High-authority guest posts (DA 40+)',
      'Premium press releases',
      'Expanded citation network',
      'Advanced GBP link building',
      'Priority support',
      'Monthly strategy call',
    ],
    cta: 'Dominate Now',
